      ...
      <li>
        ...
        <ul class="bm_sun">
          ...
          <li v-for="item in deptEmpData" :key="item.id">
              ...
              <li v-for="subDept in item.children" :key="subDept.id">
                ...
                <ul>
                  <li v-for="chrildDept in subDept.children" :key="chrildDept.id">
                      ...
                      <li v-for="dept in chrildDept.children" :key="dept.id">
                        ...
                        <ul>
                          <li v-for="dep in dept.children" :key="dep.id">
                            ...
                            <!-- 5 -->
                            <ul class="sex">
                              <li v-for="emp in dep.employeeList" :key="emp.id" @click="selectEmp(emp),retEmpObj(emp)">
                        ...
                        <!-- 4 -->
                        <ul class="sex">
                          <li v-for="emp in dept.employeeList" :key="emp.id" @click="selectEmp(emp),retEmpObj(emp)">
                            <div class=" close_menu unm mt_5">
                              <span>
                                <img v-show="emp.sex =='男'" src="@/assets/img/man.jpg" width="28" height="28" />
                                <img v-show="emp.sex =='女'" src="@/assets/img/men.jpg" width="28" height="28" />
                    ...
                    <!-- 3 -->
                    <ul class="sex">
                      <li v-for="emp in chrildDept.employeeList" :key="emp.id" @click="selectEmp(emp),retEmpObj(emp)">
                        <div class=" close_menu unm mt_5">
                          <span>
                            <img v-show="emp.sex =='男'" src="@/assets/img/man.jpg" width="28" height="28" />
                            <img v-show="emp.sex =='女'" src="@/assets/img/men.jpg" width="28" height="28" />
                ...
                <!-- 2 -->
                <ul class="sex">
                  <li v-for="emp in subDept.employeeList" :key="emp.id" @click="selectEmp(emp),retEmpObj(emp)">
                    <div class=" close_menu unm mt_5">
                      <span>
                        <img v-show="emp.sex =='男'" src="@/assets/img/man.jpg" width="28" height="28" />
                        <img v-show="emp.sex =='女'" src="@/assets/img/men.jpg" width="28" height="28" />
            ...
            <!-- 1 -->
            <ul class="sex">
              <li v-for="emp in item.employeeList" :key="emp.id" @click="selectEmp(emp),retEmpObj(emp)">
                <div class=" close_menu unm mt_5">
                  <span>
                    <img v-show="emp.sex =='男'" src="@/assets/img/man.jpg" width="28" height="28" />
                    <img v-show="emp.sex =='女'" src="@/assets/img/men.jpg" width="28" height="28" />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      retEmpObj(item) {
        this.$emit("retEmpObj", item);
      },
      //搜索数据
      searchEmp(name) {
        this.empObj = {};
        this.getEmp(this.deptEmpData, name);
        this.$parent.retEmpData(this.empObj);
      },
      //递归遍历数组查询员工
      getEmp(dataArr, name) {
        if (dataArr != null && dataArr.length > 0) {
          for (var i = 0; i < dataArr.length; i++) {
            var empArr = dataArr[i].employeeList;
            for (var x = 0; x < empArr.length; x++) {
              if (empArr[x].name == name) this.empObj = empArr[x];
            }
            if (dataArr[i].children != null && dataArr[i].children.length > 0) this.getEmp(dataArr[i].children, name);
          }
        }
      }
    },
