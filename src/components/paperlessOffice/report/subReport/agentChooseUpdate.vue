...
<!-- 选择人员 -->
<template>
  <div class="modal fade" id="agentChooseUpdateModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabeltj" aria-hidden="true">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            closeModel(){
                $("#agentChooseUpdateModel").modal('hide')
            },
            queryEmpByDept(){
