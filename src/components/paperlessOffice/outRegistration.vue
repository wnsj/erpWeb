<template>
  <div class="container user-container" id="outRegistration" v-cloak>
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="input-group">
          <span class="input-group-addon">外出人：</span>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <button type="button" class="btn btn-warning pull-right m_r_10" @click="exportTableToExcel('outTable','外出登记表')">导出</button>
        <button type="button" class="btn btn-primary pull-right m_r_10" @click="preAppBtn">添加</button>
        <button type="button" class="btn btn-warning pull-right m_r_10" @click="queryPreApp">查询</button>
      </div>
    </div>
    <br>
    <!-- 查询结果集 -->
          ...
          <table class="table table-bordered table-hover text-nowrap" id="preAppTable">
            <thead>
              <tr>
                ...
                <th class="text-center" v-if="has('71')">报备人意见</th>
                <th class="text-center" v-if="has('71')">是否取消</th>
                <th class="text-center" v-if="has('71')">点击查看</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <div class="col-md-2">暂时空</div>
          </div><!-- /.modal-header -->
          <div class="modal-body">
            <legend><h5>录入信息</h5></legend>
            <div class="form-group clearfix">
              <label class="col-md-2 control-label text-right nopad">目的地：</label>
              <div class="col-md-3">
                <input type="text" class="form-control" v-model="computerForAdd.userName">
              </div>
              <label class="col-md-2 control-label text-right nopad">外出人姓名：</label>
              <div class="col-md-3">
                <textarea class="textarea" placeholder="姓名"></textarea>
              </div>
            </div>
            <div class="form-group clearfix">
              <label class="col-md-2 control-label text-right nopad">是否直接出去：</label>
              <div class="col-md-3">
                <input type="radio" name="isOut" />
                <label class="control-label text-left nopad">是</label>
                <input type="radio" name="isOut" />
                <label class="control-label text-left nopad">否</label>
              </div> 
            ...
            <div class="form-group clearfix">
              <label class="col-md-2 control-label text-right nopad">当天是否归岗：</label>
              <div class="col-md-3">
                <input type="radio" name="isReturn" />
                <label class="control-label text-left nopad">是</label>
                <input type="radio" name="isReturn" />
                <label class="control-label text-left nopad">否</label>
              </div>
            ...
            <div class="form-group clearfix">
              <label class="col-md-2 control-label text-right nopad">外出日期：</label>
              <div class="col-md-3">
                <textarea class="textarea" placeholder=""></textarea>
              </div>
            </div>
            <div class="form-group clearfix">
              <label class="col-md-2 control-label text-right nopad">外出原因：</label>
              <div class="col-md-8">
                <textarea class="textarea" placeholder=""></textarea>
              </div>
            </div>
          ...
          <div class="modal-body">
            ...
            <div class="form-group clearfix">
              ...
              <label class="col-md-2 control-label text-right nopad">结果：</label>
...
<script>
  ...
  export default {
    ...
    methods: {
      // ---------------------------------------查询----------------------------------
	    lastMonth() {
        this.computer.beginDate = this.$queryStartLastMonth()
        this.computer.endDate = this.$queryEndLastMonth()
        // 调用查询方法
      },
      currentMonth() {
        this.computer.beginDate = this.$queryStartMonth()
        this.computer.endDate = this.$queryEndMonth()
        // 调用查询方法
      },
      nextMonth() {
        this.computer.beginDate = this.$queryStartNextMonth()
        this.computer.endDate = this.$queryEndNextMonth()
        // 调用查询方法
      },
      currentDate() {
        this.computer.beginDate = this.$currentDate()
        this.computer.endDate = this.$currentDate()
        // 调用查询方法
      },
